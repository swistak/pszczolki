...
class KnapsackProblemBee : public KnapsackProblem {
public:
    int SkautBeens;
    int WorkerBeens;
    ...
    double getBeeValue(double BagSize);
    ...
    double sprawdzenieElementow(int *bestPosition, int bestPositionIndex);
    ...
    double calculateSkautValue(int * indTab, double A_BagSize, int &LastIndex, double &TotalWeight);
    ...
    double calculateValue(int * indTab, int A_limit, double A_BagSize, double &TotalWeight, bool &A_possible);
